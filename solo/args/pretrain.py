...
def add_and_assert_online_cfg(cfg: omegaconf.DictConfig) -> omegaconf.DictConfig:
    ...
    cfg.online.batch_repeat = omegaconf_select(cfg, "online.batch_repeat", 1)
...
def parse_cfg(cfg: omegaconf.DictConfig):
    ...
    # Absolute wtf - assumes that batch size is always 256
    ...
    if cfg.optimizer.classifier_lr is not None:
